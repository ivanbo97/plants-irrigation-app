...
public class FirebaseDataExtractor {
    ...
    public static void retrieveTopicsAndPopulateBroker(FirebaseBroker mqttBroker, Iterable<DataSnapshot> topics) {
    ...
    public static void retrievePlantsAndPopulateBroker(FirebaseBroker mqttBroker, Iterable<DataSnapshot> plants) {
